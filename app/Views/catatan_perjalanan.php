...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-danger">Catatan Perjalanan</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive mb-4">
            <p>Urutkan berdasarkan <span><select id="urutkan" class="mx-2 rounded p-2 border small">
                ...
                <option value="4">Suhu nik</option>
            </select><button id="btnUrutkan" class="btn btn-danger">Urutkan</button></span></p>
        ...
        <a href="<?= base_url() ?>/isidata" class="btn btn-  float-right">
