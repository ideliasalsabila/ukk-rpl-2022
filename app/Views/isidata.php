...
<div class="card shadow mb-4" style="max-width:500px;">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-danger">Isi Data Perjalanan</h6>
    </div>
    <div class="card-body">
        <form method="post" action="<?= base_url() ?>/isidata/simpan">
            ...
            <div class="mb-4">
                <p>NIK</p>
                <input name="nik" type="number" class="form-control bg-light border-0 small" aria-label="Search" aria-describedby="basic-addon2">
            </div>
